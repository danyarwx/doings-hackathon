/**
 * SevMini stacked-isometric loader with a floating Ghost shadow.
 *
 * The supplied version used styled-components; rewrote with a scoped <style>
 * block + Tailwind so we don't pull in the whole library for one loader.
 */

import * as React from "react";

const Loader12: React.FC<React.HTMLAttributes<HTMLDivElement>> = (props) => {
  return (
    <div {...props}>
      <style>{`
        .sevmini-wrap {
        ...
        .sevmini-stack { animation: sevmini-bounce 4s infinite ease-in-out; }
        .sevmini-ghost {
          transform: translate(0px, -25px);
          z-index: -1;
          animation: sevmini-ghost-opacity 4s infinite ease-in-out;
        }
        @keyframes sevmini-bounce {
          0%, 100% { transform: translateY(0); }
          50%      { transform: translateY(-10px); }
        }
        @keyframes sevmini-ghost-opacity {
          0%, 100% { opacity: 1; transform: translate(0px, -25px) scale(1); }
          50%      { opacity: 0.5; transform: translate(0px, -25px) scale(0.9); }
        }
        @keyframes sevmini-strobe {
          0%, 100% { opacity: 1; }
          50%      { opacity: 0; }
          51%      { opacity: 1; }
        }
        @keyframes sevmini-strobe-red {
          0%, 50%, 100% { fill: #FF5F4A; }
          25%, 75%      { fill: #103573; }
        }
        @keyframes sevmini-strobe-green {
          0%, 50%, 100% { fill: #17E300; }
          25%, 75%      { fill: #17E300B4; }
        }
        #sevmini-strobe-led1 { animation: sevmini-strobe 0.5s infinite; }
        #sevmini-strobe-color1 { animation: sevmini-strobe-green 0.8s infinite; }
        #sevmini-strobe-color3 { animation: sevmini-strobe-red 0.8s infinite; animation-delay: 3s; }
      `}</style>
      <div className="sevmini-wrap">
        <div className="sevmini-stack">
          <svg
            width={74}
            height={90}
            viewBox="0 0 74 90"
          ...
          >
            ...
            <path id="sevmini-strobe-color1-a" d="M58 72.5L60.5 71V74L58 75.5V72.5Z" fill="#FF715E" />
            ...
            <path id="sevmini-strobe-color1" d="M63 51.5L65.5 50V53L63 54.5V51.5Z" fill="#FF715E" />
            ...
            <path id="sevmini-strobe-color3" d="M58 36.5L60.5 35V38L58 39.5V36.5Z" fill="#FF715E" />
            ...
            <path id="sevmini-strobe-led1" d="M55.1521 27.1464L53.2538 26.054L55.3602 24.9661L57.2585 26.0586L55.1521 27.1464Z" fill="#3A6DAB" />
          </svg>
        </div>
        <div className="sevmini-ghost">
